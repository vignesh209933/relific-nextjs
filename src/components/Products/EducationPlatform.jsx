...
const EducationPlatform = () => {
  ...
  const prototypeUrl =
    "https://www.figma.com/proto/NeSXPaitqGu3QQBTVtkBZP/School-management-app?page-id=0%3A1&node-id=4-9185&viewport=5133%2C-1063%2C0.27&t=JcSphHdUWbqjVNfp-1&scaling=scale-down&content-scaling=fixed&starting-point-node-id=4%3A9185";
          ...
          <div className="p-6 md:p-8">
            <div className="flex flex-col lg:flex-row items-center gap-10">
              <div className="w-full lg:w-2/3">
                ...
                >
                  Empowering Learning with Digital Solutions
                </h2>
                <p className="text-base" style={{ color: Colors.Font_5 }}>
                  The Education Platform is designed for social sector
                  organizations and schools to track educational impact in their
                  programs. It provides tools to monitor student progress,
                  measure learning outcomes, and enhance engagement through
                  digital solutions tailored for holistic development.
                </p>
        ...
        >
          ...
          >
            <h2 className="text-xl font-semibold">
              What Education Platform Offers
            </h2>
          </div>
          <div className="p-6">
          ...
          <div className="p-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                {
                  icon: "📚",
                  title: "Tracking Learning Outcomes",
                  description:
                    "Monitor student progress and measure educational impact.",
                },
                {
                  icon: "📊",
                  title: "Data-Driven Insights",
                  description:
                    "Leverage analytics to improve program effectiveness.",
                },
                {
                  icon: "🔄",
                  title: "Streamlined Reporting",
                  description:
                    "Simplify reporting for schools and educational programs.",
                },
                {
                  icon: "📱",
                  title: "User-Friendly Interface",
                  description:
                    "Accessible tools for educators, administrators, and students.",
                },
                {
                  icon: "📝",
                  title: "Centralized Data Management",
                  description:
                    "Store and retrieve all educational data in one place.",
                },
                {
                  icon: "🔍",
                  title: "Impact Measurement",
                  description:
                    "Measure the real-world outcomes of educational initiatives.",
                },
              ].map((challenge, index) => (
                <div
                  key={index}
