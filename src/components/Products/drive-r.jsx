...
const DriveR = () => {
  ...
  const prototypeUrl =
    "https://www.figma.com/proto/350gHWmmU7X4G9K3wyxIQt/Enterprise-management?page-id=0%3A1&node-id=1-294&viewport=871%2C406%2C0.2&t=G6ZV3rqOgmcUELD6-1&scaling=contain&content-scaling=fixed&starting-point-node-id=1%3A294";
  ...
  const challenges = [
    {
      ...
      description:
        "Drive‑R unifies data from forms, apps, Excel, and APIs into a single schema.",
    },
    {
      icon: "📉",
      title: "Lack of Ready Insights",
      description:
        "Converts raw data into SDG-aligned dashboards and compliance-ready reports.",
    },
    {
      icon: "🌐",
      title: "Offline Field Environments",
      description:
        "Works with low bandwidth, multilingual, GPS-tagged field apps.",
    },
    {
      icon: "🔄",
      title: "Migration of Legacy Data",
      description:
        "With built-in transformation logic for seamless data migration.",
    },
    {
      icon: "📊",
    ...
    },
    {
      ...
      description:
        "Easily integrates with Power BI, Superset, Airbyte, and legacy MIS.",
    },
  ];
        ...
        <div className="mb-12 sm:mb-16">
          <div className="bg-white rounded-lg p-6 sm:p-8 lg:p-10 shadow-lg border border-gray-200">
            <h2
              ...
              style={{ color: Colors.Primary_font }}
            >
              Common Data Management Challenges Drive-R Solves:
            </h2>
