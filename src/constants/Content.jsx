...
export const solutions = [
  {
    ...
    image: envi,
    description:
      "Leveraging technology to monitor environmental impact, enhance sustainability efforts, and support conservation initiatives.",
  },
  {
    title: "Agriculture",
    image: agri,
    description:
      "Empowering farmers with data-driven insights, precision farming techniques, and digital tools to improve productivity and sustainability.",
  },
  {
    title: "Education",
    image: edu,
    description:
      "Enhancing learning experiences through digital platforms, personalized educational resources, and skill-based training solutions.",
  },
  {
    title: "Healthcare",
    image: heal,
    description:
      "Providing innovative healthcare solutions, telemedicine support, and data-driven approaches to improve patient outcomes and accessibility.",
  },
  {
    title: "Grant Management",
    image: grant,
    description:
      "Streamlining the grant application, tracking, and reporting processes with digital tools to ensure transparency and efficiency.",
    path: "/grant_management", // Updated path
  },
  {
    title: "Skilling & Livelihood",
    image: SnL,
    description:
      "Facilitating skill development programs and employment opportunities to enhance livelihoods and economic independence.",
  },
];
...
export const tracseedFeatures = [
  { title: "Real-time progress tracking of seed production", image: r1a },
  {
    title: "Seamless Production planning and collaboration",
    image: r1c,
  },
  { title: "Comprehensive seed organizer dashboard", image: r1b },
];
...
export const eduFeatures = [
  {
    title:
      "Track student enrollment, retention, and attendance records across programs",
    image: e1b,
    imageClass: "w-full h-40 object-cover rounded-lg",
  },
  {
...
export const healthFeatures = [
  {
    title:
      "Track patient registrations, follow-ups, and community outreach efforts",
    image: e1b,
    imageClass: "w-full h-40 object-cover rounded-lg",
  },
  {
    title:
      "Coordinate mobile clinics, health camps, and field worker schedules",
    image: e2a,
    imageClass: "w-full h-40 object-cover rounded-lg",
  },
  {
  ...
  {
    title:
      "Manage medical supplies, equipment, and essential medicine distribution",
    image: e1c,
    imageClass: "w-full h-40 object-cover rounded-lg",
  },
  {
  ...
  {
    title:
      "Generate health impact reports for donors, NGOs, and public partners",
    image: e1a,
    imageClass: "w-full h-40 object-cover rounded-lg",
  },
];
...
export const SurveRFeatures = [
  {
    title:
      "Design mobile forms with validations, skip logic, and multimedia fields",
    image: sr1b,
    imageClass: "w-full h-40 object-cover rounded-lg",
  },
  {
